...
namespace eosiosystem {
   ...
   //hdkim(OASISBloc)
   static constexpr int32_t   BG_total              = 7;
   static constexpr int32_t   WG_total              = 13;
   static constexpr int32_t   WG_min_point          = 8;
   static constexpr uint32_t min_stake_per_BG      = 50'0000;
   static constexpr uint32_t blocks_per_once_round = 12;
   ...
   static constexpr uint32_t blocks_per_day        = seconds_per_day; // half seconds per day

   //static constexpr int64_t  min_activated_stake   = 150'000'000'0000;
   static constexpr int64_t  min_activated_stake   = 0;
   ...
   struct [[eosio::table("global"), eosio::contract("eosio.system")]] eosio_global_state : eosio::blockchain_parameters {
      ...
      //hdkim(OASISBloc)
      //int64_t              last_producer_schedule_update_time = 0;
      //uint32_t              last_bg_total=7;
      //name                  now_work_BG;
      //uint8_t               count_generated_block = 12;
      ...
      EOSLIB_SERIALIZE_DERIVED( eosio_global_state, eosio::blockchain_parameters,
                                ...
                                (last_producer_schedule_size)(total_producer_vote_weight)(last_name_close)/*(last_producer_schedule_update_time)(last_bg_total)(now_work_BG)(count_generated_block)*/)
   };
   ...
   struct [[eosio::table("global4"), eosio::contract("eosio.system")]] eosio_global_state4 {
         ...
         EOSLIB_SERIALIZE( eosio_global_state4, (last_producer_schedule_update_time)(last_bg_total)(now_work_BG)(count_generated_block) )
   };
   ...
   struct [[eosio::table, eosio::contract("eosio.system")]] producer_info {
      ...
      //hdkim(OASISBloc)
    /*  uint16_t              group = 0;   //0 = normal,  1 = Block Generator , 2 = Witness Group
      uint16_t              levle = 0;
      double                compliance = 1000.; //규정 준수도
      double                contribution = 1.;  //기여도
      uint32_t              my_rand_number = 0;
      uint32_t              generated_block_at_schedule = 0;
      uint32_t              stake;
      double                deposit_point;*/
      ...
      EOSLIB_SERIALIZE( producer_info, (owner)(total_votes)(producer_key)(is_active)(url)
                        (unpaid_blocks)(last_claim_time)(location)/*(group)(levle)(compliance)(contribution)(my_rand_number)
                         (generated_block_at_schedule)(stake)(deposit_point)*/)
   };
   ...
   struct [[eosio::table, eosio::contract("eosio.system")]] producer_info3 {
         ...
         // explicit serialization macro is not necessary, used here only to improve compilation time
         EOSLIB_SERIALIZE( producer_info3, (owner)(group)(level)(compliance)(contribution)(my_rand_number)(generated_block_at_schedule)(stake)(deposit_point) )
    };
   ...
   //hdkim(OASISBloc)
   struct [[eosio::table,eosio::contract("eosio.system")]]  ePoA_state{
     uint8_t             total_BG = 0 ;
     uint64_t            counter_last_BG = 0;
     bool                last_bg_woking_state = false;
     name                starting_bg_name_schedule;
     name                ending_bg_name_schedule;

     uint64_t primary_key()const { return 0; }

     // explicit serialization macro is not necessary, used here only to improve compilation time
     EOSLIB_SERIALIZE( ePoA_state, (total_BG)(counter_last_BG)(last_bg_woking_state)(starting_bg_name_schedule)(ending_bg_name_schedule))
   };

   typedef eosio::multi_index< "epoa"_n,ePoA_state> ePoA_state_table;
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      private:
         ...
         global_state4_singleton _global4; // by wschoi(OASISBloc)


         eosio_global_state      _gstate;
         eosio_global_state2     _gstate2;
         eosio_global_state3     _gstate3;
         eosio_global_state4     _gstate4; // by wschoi(OASISBloc)
      ...
      public:
         ...
         // Modified by hdkim
         static constexpr eosio::name token_account{"osbio.token"_n};
         // Origin
         ...
         // Modified by wschoi
         static constexpr eosio::name bpay_account{"osbio.bpay"_n};
         // Origin
         ...
         // Modified by wschoi
         static constexpr eosio::name saving_account{"osbio.saving"_n};
         // Origin
         ...
         // eosio modified by wschoi
         /*static symbol get_core_symbol( name system_account = "osbio"_n ) {
         ...
         // regproducer modified by wschoi
         void reggen( const name& producer, const public_key& producer_key, const std::string& url, uint16_t location );
         // Origin
         ...
         // unregprod modified by wschoi
         void unreggen( const name& producer );
         // Origin
         ...
         // voteproducer modified by wschoi
         void votegen( const name& voter, const name& proxy, const std::vector<name>& producers );
         // Origin
         ...
         //hdkim(OASISBloc)
         [[eosio::action]]
         void startepoa(  const name& owner );
         ...
         // regproducer modified by wschoi
         using regproducer_action = eosio::action_wrapper<"reggen"_n, &system_contract::reggen>;
         // Origin
         ...
         // unregprod modified by wschoi
         using unregprod_action = eosio::action_wrapper<"unreggen"_n, &system_contract::unreggen>;
         // Origin
         ...
         // voteproducer modified by wschoi
         using voteproducer_action = eosio::action_wrapper<"votegen"_n, &system_contract::votegen>;
         // Origin
         ...
         //hdkim(OASISBloc)
         using startepoa_action = eosio::action_wrapper<"startepoa"_n, &system_contract::startepoa>;
      ...
      private:
         ...
         //hdkim(OASISBloc)
         // defined in ePoA.cpp
         void push_schedule(const block_timestamp& block_time);
         int32_t osb_rand(void){
            next = next * 1103515245 + 12345;
            return (uint32_t)(next>>16) & 0x7fff;
         }
         void osb_srand(uint32_t seed){
            next = seed;
         }
         void convert_amount_of_stake_quantity_to_table();
         double calculate_level_point_by_witness_group(const name bg);
