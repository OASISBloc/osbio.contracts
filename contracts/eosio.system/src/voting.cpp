...
namespace eosiosystem {
   ...
   void system_contract::reggen( const name& producer, const eosio::public_key& producer_key, const std::string& url, uint16_t location ) {
   ...
   void system_contract::unreggen( const name& producer ) {
   ...
   void system_contract::votegen( const name& voter_name, const name& proxy, const std::vector<name>& producers ) {
